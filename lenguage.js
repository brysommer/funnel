...
Запуск і підтримка: Після запуску бота здійснюється моніторинг роботи, виправлення помилок та надання підтримки для безперебійної роботи.
    `,
  consultation:
    "Щоб розпочати безкоштовну індивідуальну консультацію, натисніть кнопку «🗣️ Отримати консультацію» та отримайте готові рішення для вашого бізнесу вже зараз! 🚀",
...
const keyboards = {
  cases: {
    inline_keyboard: [
      ...
      [
        {
          text: "⚙️ Автоматизація роботи з данними",
          callback_data: "data_automation",
        },
      ],
